    ...
    public partial class Attractiveness
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"F_Age", @"F_Age"),new InputOutputColumnPair(@"S_Age", @"S_Age")})      
                                    ...
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"F_Handedness",outputColumnName:@"F_Handedness"))      
                                    ...
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"S_Handedness",outputColumnName:@"S_Handedness"))      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"F_Age",@"S_Age",@"F_EyeColor",@"F_HairType",@"F_Handedness",@"F_Morphotype",@"F_Intelligence",@"F_HeightPotential",@"F_Sex",@"F_BehaviorPropension",@"S_EyeColor",@"S_HairType",@"S_Handedness",@"S_Morphotype",@"S_Intelligence",@"S_HeightPotential",@"S_Sex",@"S_BehaviorPropension"}))      
